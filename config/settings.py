...
from utils.video_devices import discover_video_capture_indices
...
_DISCOVERED_CAMERA_INDICES = discover_video_capture_indices()
CAMERA_INDICES = _DISCOVERED_CAMERA_INDICES if _DISCOVERED_CAMERA_INDICES else [0, 8]  # 사용 가능한 카메라 인덱스 리스트
